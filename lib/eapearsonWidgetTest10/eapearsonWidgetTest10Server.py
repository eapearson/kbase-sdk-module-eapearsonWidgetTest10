...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'eapearsonWidgetTest10'):
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'eapearsonWidgetTest10'
        ...
        self.rpc_service.add(impl_eapearsonWidgetTest10.run_eapearsonWidgetTest10,
                             name='eapearsonWidgetTest10.run_eapearsonWidgetTest10',
                             types=[dict])
        self.method_authentication['eapearsonWidgetTest10.run_eapearsonWidgetTest10'] = 'required'  # noqa
        self.rpc_service.add(impl_eapearsonWidgetTest10.status,
                             name='eapearsonWidgetTest10.status',
                             types=[dict])
